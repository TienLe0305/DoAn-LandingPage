        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black  sm:text-4xl sm:leading-tight tracking-[-2.88px] text-7xl font-medium leading-[1.14] pb-1">
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="shadow-three  mb-10 mt-12 rounded-sm bg-white p-6 dark:shadow-none lg:mt-0">
              ...
              <div className="shadow-three  mb-10 rounded-sm bg-white dark:shadow-none">
